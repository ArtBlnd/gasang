...
pub enum AArch64Instr {
    ...
    Casb(CompareAndSwap),
    Caslb(CompareAndSwap),
    Casab(CompareAndSwap),
    Casalb(CompareAndSwap),
    Cash(CompareAndSwap),
    Caslh(CompareAndSwap),
    Casah(CompareAndSwap),
    Casalh(CompareAndSwap),

    CasVar32(CompareAndSwap),
    CaslVar32(CompareAndSwap),
    CasaVar32(CompareAndSwap),
    CasalVar32(CompareAndSwap),
    CasVar64(CompareAndSwap),
    CaslVar64(CompareAndSwap),
    CasaVar64(CompareAndSwap),
    CasalVar64(CompareAndSwap),
}
