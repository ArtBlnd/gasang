...
pub struct RmRnRd {
    pub rm: AArch64Register,
    pub rn: AArch64Register,
    pub rd: AArch64Register,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub struct RmRaRnRd {
    pub rm: AArch64Register,
    pub ra: AArch64Register,
    pub rn: AArch64Register,
    pub rd: AArch64Register,
}
